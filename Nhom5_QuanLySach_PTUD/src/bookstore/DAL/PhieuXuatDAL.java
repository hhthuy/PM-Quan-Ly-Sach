...
public class PhieuXuatDAL extends SqlDataConnection{
    private final String INSERT = "insert into tb_PhieuXuat(maPhieuXuat,maKH,ngayXuat,thanhTien) values(?,?,?,?)";
    private final String UPDATE = "UPDATE [dbo].[tb_PhieuXuat] SET [maKH] = ? ,[thanhTien] = ? WHERE [maPhieuXuat] = ?";
