 ...
 *
 */
public class frmChonNhaXuatBan extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frmChonNhaXuatBan frame = new frmChonNhaXuatBan();
	...
	public void initComponents() {
		...
		btnChon.setBounds(379, 10, 106, 40);
		panel_2.add(btnChon);
		
		JButton btnThemNXB = new JButton("Thêm nhà xuất bản");
		btnThemNXB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				btnThemNXB();
			}
		});
		btnThemNXB.setForeground(Color.BLACK);
		btnThemNXB.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		btnThemNXB.setBorder(null);
		btnThemNXB.setBackground(new Color(0, 153, 153));
		btnThemNXB.setBounds(507, 10, 171, 40);
		panel_2.add(btnThemNXB);
	...
	public void btnThemNXB() {
		setVisible(false);
		pnNhaXuatBan pn = new pnNhaXuatBan();
	...
	public void chonNXB() {
		if(tblNXB.getSelectedRow()<0) {
			...
			setVisible(false);
			pnHoaDonNhapHang.txtNhaXuatBan.setText(tblNXB.getValueAt(tblNXB.getSelectedRow(), 1).toString());
		}
	}
